/*
  ...
  Cada regalo es un string. Necesitamos que la máquina 
  envuelva cada regalo en papel de regalo y lo coloque en un 
  array de regalos envueltos.
  ...
  ¡Ojo! Asegúrate que pones el número correcto de * 
  para envolver completamente el string. Pero no demasiados. 
...
function wrapping(gifts) {
  ...
  const arr = gifts.map(g => {
    let size = g.length;
    let deck = '*'.repeat(size+2);
